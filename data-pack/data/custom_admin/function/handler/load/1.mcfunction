...
execute unless data storage mc:handler data.meta run data modify storage mc:handler data.meta set value [{version:"v1.2.0",pack:"Gulce's Permissions (1.21.4)"}]
...
# Yükleme mesajı
tellraw @a ["",{"text":"[GULCE] ","color":"gold","bold":true},{"text":"Admin Power v1.2.0 yüklendi!","color":"green"}]
